...
class MVSDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        for i, vid in enumerate(view_ids):
            ...
            ## NOTE: The path to GC-Mask should be updated before running.
            # mask_filename_hr = os.path.join(self.datapath, 'Depths_raw/{}/depth_visual_{:0>4}.png'.format(scan, vid))
            mask_filename_hr = os.path.join(self.datapath, 'gc_mask/th_2_025_n8/{}/geomask_{:0>4}.png'.format(scan, vid))
